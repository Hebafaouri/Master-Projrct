                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            ...
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-1.') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-3.') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-4.') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-5.') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-6.') }}" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('/imgs/shop/product-16-7.') }}" alt="product image">
                                            </figure>
                                        </div>
                                        <!-- THUMBNAILS -->
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-3.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-4.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-5.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-6.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-7.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-8.') }}" alt="product image"></div>
                                            <div><img src="{{ asset('/imgs/shop/thumbnail-9.') }}" alt="product image"></div>
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-twitter"> <a href="#"><img src="{{ asset('/imgs/theme/icons/icon-twitter.')}}" alt=""></a></li>
                                            <li class="social-instagram"><a href="#"><img src="{{ asset('/imgs/theme/icons/icon-instagram.')}}" alt=""></a></li>
                                            <li class="social-linkedin"><a href="#"><img src="{{ asset('/imgs/theme/icons/icon-pinterest.')}}" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('/imgs/page/avatar-6.') }}" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('/imgs/page/avatar-7.') }}" alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('/imgs/page/avatar-8.') }}" alt="">
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{ asset('/imgs/shop/product-2-1.') }}" alt="">
                                                            <img class="hover-img" src="{{ asset('/imgs/shop/product-2-2.') }}" alt="">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{ asset('/imgs/shop/product-3-1.') }}" alt="">
                                                            <img class="hover-img" src="{{ asset('/imgs/shop/product-4-2.') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{ asset('/imgs/shop/product-4-1.') }}" alt="">
                                                            <img class="hover-img" src="{{ asset('/imgs/shop/product-4-2.') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                        ...
                                        <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up mb-0">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="product-details.html" tabindex="0">
                                                            <img class="default-img" src="{{ asset('/imgs/shop/product-5-1.') }}" alt="">
                                                            <img class="hover-img" src="{{ asset('/imgs/shop/product-3-2.') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-search"></i></a>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('/imgs/shop/thumbnail-3.') }}" alt="#">
                                </div>
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('/imgs/shop/thumbnail-4.') }}" alt="#">
                                </div>
                                <div class="content pt-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('/imgs/shop/thumbnail-5.') }}" alt="#">
                                </div>
                                <div class="content pt-10">
